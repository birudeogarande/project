...
<div class="container" role="main">
	...
	<form method="post" action="https://css-tricks.com/examples/DragAndDropFileUploading//?submit-on-demand" enctype="multipart/form-data" novalidate class="box">
		...
		<div class="box__input">
			...
			<input type="file" name="files[]" id="file" name="upload_file" class="box__file" data-multiple-caption="{count} files selected" multiple />
			<label for="file"><strong>Choose a file</strong><span class="box__dragndrop"> or drag it here</span>.</label>
			<button type="submit" class="box__button" class="is-selected" name="uploadfile">Upload</button>
		</div>
...
if(isset($_POST['uploadfile'])){
	include("includes/connect.php");
	 ...
	 $post_image=$_FILES['upload_file']['name'];
	 $image_tmp=$_FILES['upload_file']['tmp_name'];
...
else
{
	...
	$insert_query="insert into posts(Document)values('$post_image')";
      if(mysqli_query($connect,$insert_query))
      {
      	echo "<script>window.open('page_1.php','_self')</script>";
