...
ResultSet rs= st.executeQuery("SELECT * from freedocument where free_id='"+free_id+"'");
while (rs.next()){
...
%>
   ...
   <label style="color: #008AB3;margin-left:-60%"><h4><b><%= rs.getString("title_doc") %></b></h4></label>
     ...
     <%= rs.getString("documentSummary") %></p></td>
