...
$(document).ready(function(){
    ...
    $("img").click(function(){
    	alert("You really wan't Delete this File.");
        $("#delete").remove();
    });
});
</script>
	...
	<div id="base" class="">
		...
		<div id="u84" class="ax_default heading_2">
			...
			<div id="u85" class="text" style="visibility: visible;">
				...
				<p>
					<span>Â© 2016 Doclance&nbsp; -&nbsp; Terms and
...
<div class="container" style="margin-top: 10px; margin-left: -5.9cm; width:900px">
<div class="scroll">

 
  <table class="table table-bordered" style="width:130%;top:10%">
...
ResultSet resultSet = st.executeQuery("SELECT * from sale_document where sale_id='"+sale_id+"'");
...
%>
   ...
   <label style="color: #008AB3;margin-left:-60%"><h4><b><%= resultSet.getString("titleDoc") %></b></h4></label>
      <a class="close" onclick="window.location.href='/Docland/uploaddocument/uploadHome123.jsp'">×</a>
...
<%}  if(".sql".equalsIgnoreCase(resultSet.getString("documentType")) ){
	...
	<%} %>
      ...
      <td height="250">
       ...
       <p class="comment more" style="text-align:justify"><label style="margin-left:-3%;"></label>
      
     <%= resultSet.getString("documentSummary") %></p></td>
      
      </tr>
     
      <tr>
        <td>
        <label style="margin-left:-80%">Keyword:</label>
        <%= resultSet.getString("documentKeyword") %></td>
		...
		return false;
					...
					<form action="#" method="post" class="form-horizontal" id="myform">
						...
						<div id="u546" class="ax_default line">
							<img id="u546_img" class="img " src="images/uploadhome/u544.png" />
							<!-- Unnamed () -->
