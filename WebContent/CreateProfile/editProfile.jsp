     ...
     <li><a href="#" style="background-color:#E2F5FE;margin-left:8px;margin-right:8px;  margin-bottom:5px"><p align="left">Jobs</p></a></li>
      <li><a href="#" style="background-color:#E2F5FE;margin-left:8px;margin-right:8px;  margin-bottom:5px"><p align="left">Blog Posts</p></a></li>
            ...
            <div id="u55" class="ax_default heading_3">
             ...
             <p><span><%=resultSet.getString("name") %></span></p>
              </div>
            </div>
            ...
            <div id="u57" class="ax_default heading_3">
              ...
              <div id="u58" class="text" style="visibility: visible;">
               <%--  <p><span><%=resultSet.getString("last_name") %></span></p> --%>
      ...
      <form action="/Docland/CounsaltantUpdateProfile" method="post" enctype="multipart/form-data" id="form1">
          ...
          <div id="u191_state0_content" class="panel_state_content">
            ...
            <div id="u200" class="ax_default paragraph">
              ...
              <div id="u201" class="text" style="visibility: visible;">
                <p><span><a href="/Docland1/logout.jsp">Logout</a></span></p>
              </div>
            </div>
      ...
      <div id="u206" class="ax_default html_button">
        <input id="u206_input" type="submit" value="Save"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u207" class="ax_default text_field">
        <input id="u207_input" type="text" name="name" placeholder="Name" value="<%=resultSet.getString("name") %>"/></span>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u208" class="ax_default text_field">
        <input id="u208_input" type="text" name="email" placeholder="Email" value="<%=resultSet.getString("email") %>"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u209" class="ax_default text_field">
        <input id="u209_input" type="text" name="qualification" placeholder="Qualification" value="<%=resultSet.getString("qualification") %>"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u210" class="ax_default text_field">
        <input id="u210_input" type="text" name="professional" placeholder="Professional/ Experience" value="<%=resultSet.getString("professional") %>"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u211" class="ax_default text_field">
        <input id="u211_input" type="text" name="rewords" placeholder="Rewards/Recognitions/Publications" value="<%=resultSet.getString("professional") %>"/>
      </div>
      ...
      <div id="u411" class="ax_default text_field">
        <input id="u411_input" type="text" name="skills" placeholder="Skills/Interests" value="<%=resultSet.getString("skills") %>"/>
      </div>
      ...
      <div id="u414" class="ax_default text_field">
        <input id="u414_input" type="text" name="references" Placeholder="References" value="<%=resultSet.getString("references") %>"/>
      </div>
      ...
      <div id="u417" class="ax_default text_field">
        <input id="mobile-number" type="text" name="mobileNumber" style="width:341px;height:33px"  value="<%=resultSet.getString("mobileNumber") %>"  ">
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u418" class="ax_default text_field">
        <input id="u418_input" type="text" name="website" placeholder="Website" value="<%=resultSet.getString("website") %>"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u419" class="ax_default text_field">
        <input id="u419_input" type="text" name="language" Placeholder="Language" value="<%=resultSet.getString("language") %>"/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u420" class="ax_default text_field">
        <input id="u420_input" type="text" name="address" placeholder="Address" value="<%=resultSet.getString("address") %>"/>
      </div>
      ...
      <div id="u429" class="ax_default text_field">
        <input id="u429_input" type="text" name="state" placeholder="State/County/Province/Region" value="<%=resultSet.getString("state") %>"/>
      </div>
      ...
      <div id="u458" class="ax_default text_field">
        <input type="file" name="file" id="fileinput" value="<%=resultSet.getString("fileName") %>"/>
...
<!-- Unnamed (Rectangle) -->
      ...
      <div id="u488" class="ax_default image">
        <img  width="100" height="100" src="/Docland/DisplayImageServlet?id=<%=id%>" id="dp"/>
        <!-- Unnamed () -->
      ...
      <div id="u496" class="ax_default text_field">
       <input type="file" name="file1" id="fileinput1" value="<%=resultSet.getString("fileName1") %>"/>
      </div>
      ...
      <div id="u503" class="ax_default text_field">
        <input type="file" name="file2" id="fileinput2" value="<%=resultSet.getString("fileName2") %>"/>
      </div>
     ...
     <!--  <div id="u508" class="ax_default box_1">
      ...
      <div id="u516" class="ax_default text_field">
        <input id="u516_input" type="text" name="country" placeholder="Country" value="<%=resultSet.getString("country") %>" onkeypress="checkName()"/>
      </div>
      ...
      <div id="u521" class="ax_default button">
        ...
        <div id="u522" class="text" style="visibility: visible;">
          <p><span><input type="file" name="profile_picture" id="profile_picture" style="width:100px;height:30px" value="/Docland/DisplayImageServlet?id=<%=id%>"></span></p>
          <!-- Upload Picture -->
        </div>
      </div>
      ...
      <div id="u523" class="ax_default text_field">
        <input id="u523_input" type="text" name="city" placeholder="City" value="<%=resultSet.getString("city") %>"/>
      </div>
      ...
      <div id="u528" class="ax_default text_field">
        <input id="u528_input" type="text" name="postal_code" placeholder="Zip/Postal Code" value="<%=resultSet.getString("post_code") %>"/>
      </div>
...
function checkName(){
	...
	var cName = $("#u516_input").val();
	console.log(cName)
	if(cName == "India"){
		$("#mobile-number").val("+91")
	}else if(cName == "Pak"){
		$("#mobile-number").val("+92")
	}
